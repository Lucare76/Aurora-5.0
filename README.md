...
- CI con typecheck, test, production build e Playwright E2E;
- onboarding guidato;
...
- `audit/AURORA_5_PRODUCTION_READINESS_2026-09-17.md` — fotografia corrente dello stato prodotto e del debito tecnico residuo.
