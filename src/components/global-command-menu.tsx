...
export const quickCommands: Array<QuickCommand & { icon: LucideIcon }> = [
  ...
  { id: 'financial-journal-close', group: 'Azioni rapide', title: 'Chiudi il mese', subtitle: 'Salva il bilancio mensile e gli insight', href: '/financial-journal', keywords: ['chiusura mese', 'bilancio mensile', 'insight', 'timeline finanziaria'], icon: BookCheck },
  ...
  { id: 'financial-journal', group: 'Navigazione', title: 'Bilancio mensile', subtitle: 'Chiusure, insight e timeline finanziaria', href: '/financial-journal', keywords: ['bilancio', 'chiusura mensile', 'insight', 'timeline patrimonio'], icon: BookCheck },
