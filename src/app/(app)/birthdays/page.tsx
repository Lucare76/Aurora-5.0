  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <h1 className="text-2xl font-bold text-slate-900">Compleanni</h1>
  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      {birthdays.length === 0 ? (
        <EmptyState
          icon={Cake}
          title="Nessun compleanno"
          description="Aggiungi i compleanni delle persone importanti."
        />
      ) : (
        <Card>
          <CardHeader>
              ...
              {birthdays.map((b) => (
                ...
                >
                  ...
                  <span className="text-sm tabular-nums text-slate-500">
                    {formatDate(b.birth_date, 'dd MMMM')}
                  </span>
                </div>
              ))}
            </div>
